...
-- 2. Create Canned Responses Table
...
-- 3. Update get_support_conversations
...
-- 5. Update get_admin_messages for pagination
...
BEGIN
    ...
    ORDER BY m.created_at DESC -- Use DESC for pagination (fetching latest first)
